...
/**
 * @file
 * A form to connect an emauil address for RSVP details.
 */
...
class RSVPForm extends FormBase {
    ...
    public function submitForm(array &$form, FormStateInterface $form_state)
    {
        try {
            ...
            \Drupal::messenger()->addMessage(t('Unable to save RSVP settings at this time due to database error. Please try again.'));
        }
    }
}